...
setwd("/Users/albaperis/Desktop/Alba/KnowingNeurons/article/data_manuscript")
...
data # view the data for the whole site 
```
...
gen.site #view the english site data 
...
spanish.site # view spanish site data
...
setwd("/Users/albaperis/Desktop/Alba/KnowingNeurons/article/data_manuscript/")
#Load all the data 
statedata<-read.csv('data_USA_20230101-20230630.csv', header=TRUE)
colnames(statedata) <- c('state','when','segment','users')

statedata$state <- as.factor(statedata$state)
statedata$when <- as.factor(statedata$when)
